...
using Ultraviolet.Thraxus.Common.Utilities.Tools.Logging;
using Ultraviolet.Thraxus.DataTypes;

namespace Ultraviolet.Thraxus.Utilities
{
		...
		private static void ClassifySpawnGroups()
		{
			foreach (MySpawnGroupDefinition spawnGroupDefinition in MyDefinitionManager.Static.GetSpawnGroupDefinitions())
			{
				try
				{
					...
					string mod = spawnGroupDefinition.Context.ModName;
