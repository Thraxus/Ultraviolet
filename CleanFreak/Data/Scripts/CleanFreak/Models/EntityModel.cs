...
using Ultraviolet.CleanFreak.Common.BaseClasses;
using Ultraviolet.CleanFreak.Common.DataTypes;
using Ultraviolet.CleanFreak.Common.Settings;
using Ultraviolet.CleanFreak.Common.Utilities.Statics;
using Ultraviolet.CleanFreak.DataTypes;
using Ultraviolet.CleanFreak.Settings;
using Ultraviolet.CleanFreak.Settings.Custom;
using Ultraviolet.CleanFreak.Utilities;
using VRage.Game.Entity;
using VRage.Game.ModAPI;
using VRage.ModAPI;
using VRageMath;

namespace Ultraviolet.CleanFreak.Models
{
